...
public class TimeUtil
{
  ...
  public static Date convertString(String value, String format)
  {
    ...
    if (value == null)
      return null;
    try {
      return sdf.parse(value); } catch (Exception e) {
    }
    return null;
  }
  ...
  public static String getTime(Long millseconds)
  {
    ...
    long minuteMillseconds = millseconds.longValue() - days * 1000 * 60 * 60 * 24 - 
      hours * 1000 * 60 * 60;
  ...
  public static long getMillsByDateString(String strDate)
  {
    ...
    if ((strDate != null) && (strDate.trim().length() > 9)) {
      ...
      try {
        ...
        String str = String.valueOf(cal.getTimeInMillis());
        return 
          Long.parseLong(str.substring(0, str.length() - 3) + "000");
      }
    ...
    throws Exception
  {
    try
    {
      ...
      if ((ca.get(11) == 0) && (ca.get(12) == 0) &&
        (ca.get(13) == 0))
        myformat = new SimpleDateFormat("yyyy-MM-dd");
      else {
        myformat = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
      }
      return myformat.format(date); } catch (Exception e) {
    }
    return "-";
  }
