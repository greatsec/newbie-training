...
package com.greatsec.demo.generate;
...
import com.greatsec.demo.common.utils.FileUtils;
import com.greatsec.demo.common.utils.FreeMarkers;
...
public class Generate {
	...
	public static void main(String[] args) throws Exception {
		...
		// 模板文件路径
		String tplPath = StringUtils.replace(projectPath+"/src/main/java/com/greatsec/demo/generate/template", "/", separator);
