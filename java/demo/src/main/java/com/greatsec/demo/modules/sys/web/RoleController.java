...
import com.greatsec.demo.modules.sys.service.OfficeService;
...
//			addMessage(redirectAttributes, "删除角色失败, 不能删除当前用户所在角色");
    ...
    public String dialog(HttpServletRequest request, HttpServletResponse response,Model model) {
        ...
        return "modules/sys/roleDialog/roleDialog";
    }

    @RequiresUser
    @RequestMapping({"selector"})
    public String selector(Role role,HttpServletRequest request, HttpServletResponse response,Model model) {
        String isSingle = RequestUtil.getString(request, "isSingle", "false");
        ...
        return "modules/sys/roleDialog/roleSelector";
    }
