...
<script src="${ctxStatic}/jquery/jquery.lSelect.js" type="text/javascript"></script>
...
<link href="${ctxStatic}/common/app.min.css" type="text/css" rel="stylesheet"/>
<script src="${ctxStatic}/common/app.min.js" type="text/javascript"></script>
<script src="${ctxStatic}/js/util.js" type="text/javascript"></script>
