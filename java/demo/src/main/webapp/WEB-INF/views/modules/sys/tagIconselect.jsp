...
<ul class="the-icons clearfix" id="icons">
    ...
    <li><i class="icon-schedule"></i>schedule</li>
    <li><i class="icon-applied-process"></i>applied-process</li>
    <li><i class="icon-participated-process"></i>participated-process</li>
    <li><i class="icon-personal-information"></i>personal-information</li>
    <li><i class="icon-password"></i>password</li>
    
    <li><i class="icon-clinical-check-list"></i>clinical-check-list</li>
    <li><i class="icon-research-check-list"></i>research-check-list</li>
    <li><i class="icon-sample-list"></i>sample-list</li>
    <li><i class="icon-report-download"></i>report-download</li>
    
    <li><i class="icon-report-application"></i>report-application</li>
    <li><i class="icon-applied-report"></i>applied-report</li>
    <li><i class="icon-report-mail-application"></i>report-mail-application</li>
    <li><i class="icon-applied-report-mail"></i>applied-report-mail</li>
    <li><i class="icon-apply-invoice"></i>apply-invoice</li>
    <li><i class="icon-applied-invoice"></i>applied-invoice</li>
    <li><i class="icon-apply-sample-return"></i>apply-sample-return</li>
    <li><i class="icon-applied-sample-return"></i>applied-sample-return</li>
    <li><i class="icon-material-sent"></i>material-sent</li>
    
    <li><i class="icon-business-funds"></i>business-funds</li>
    
    <li><i class="icon-sample-source-statistics"></i>sample-source-statistics</li>
    <li><i class="icon-sales-summary"></i>sales-summary</li>
    <li><i class="icon-sample-statistics"></i>sample-statistics</li>
    <li><i class="icon-financial-statistics"></i>financial-statistics</li>
    
    <li><i class="icon-user-management"></i>user-management</li>
    <li><i class="icon-institution-management"></i>institution-management</li>
    <li><i class="icon-regional-management"></i>regional-management</li>
    <li><i class="icon-menu-management"></i>menu-management</li>
    <li><i class="icon-role-management"></i>role-management</li>
    <li><i class="icon-dictionary-management"></i>dictionary-management</li>
    <li><i class="icon- process-management"></i> process-management</li>
    <li><i class="icon-query-log"></i>query-log</li>
</ul>
</body>